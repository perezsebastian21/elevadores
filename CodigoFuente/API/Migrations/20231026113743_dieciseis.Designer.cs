...
namespace rsAPIElevador.Migrations
{
    ...
    [Migration("20231026113743_dieciseis")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EV_MaquinaEV_Velocidades", b =>
                {
                    b.Property<int>("EV_MaquinaIdMaquina")
                        .HasColumnType("integer");

                    b.Property<int>("EV_VelocidadesIdVelocidad")
                        .HasColumnType("integer");

                    b.HasKey("EV_MaquinaIdMaquina", "EV_VelocidadesIdVelocidad");

                    b.HasIndex("EV_VelocidadesIdVelocidad");

                    b.ToTable("EV_MaquinaEV_Velocidades");
                });
            ...
            modelBuilder.Entity("EV_MaquinaEV_Velocidades", b =>
                {
                    b.HasOne("rsAPIElevador.DataSchema.EV_Maquina", null)
                        .WithMany()
                        .HasForeignKey("EV_MaquinaIdMaquina")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("rsAPIElevador.DataSchema.EV_Velocidades", null)
                        .WithMany()
                        .HasForeignKey("EV_VelocidadesIdVelocidad")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
